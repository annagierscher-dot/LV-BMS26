...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define BP_MAX_BAR					100.0

#define BP_BITS_FAILURE				0.65*0.504*3.3/5/3.3 * 4095
#define BP_F_BITS_MAX				4.5*3.3/5*4096/3.3
#define BP_F_BITS_MIN				0.504*3.3/5/3.3 * 4095
#define BP_R_BITS_MAX				4.5*3.3/5*4096/3.3
#define BP_R_BITS_MIN				0.504*3.3/5/3.3 * 4095

#define BP_BITS_DEADZONE			0
...
extern osThreadId_t CurrentTaskHandle;
extern osThreadId_t StatusLedTaskHandle;
extern osThreadId_t FETTaskHandle;
extern osThreadId_t CANSendTaskHandle;
extern osThreadId_t FMSTaskHandle;
...
void StartFETTask(void *argument);
void StartCANSendTask(void *argument);
void StartFMSTask(void *argument);
